...
\item\label{dc21:1:5} $\vdash\metavariable{A}$ by Cor\ref{cor:prop:explode}(\ref{dc21:1:1}, \ref{dc21:1:4})
\end{pf}
\item 
\begin{pf}
...
\item\label{dc21:2:5} $\vdash\metavariable{B}$ by Cor\ref{cor:prop:explode}(\ref{dc21:2:1}, \ref{dc21:2:4})
\end{pf}
\end{enumerate}

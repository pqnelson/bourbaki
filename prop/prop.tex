...
\item 
\begin{pf}
\item\label{dc21:1:1} $\vdash\neg\metavariable{A}\implies\neg\metavariable{A}\lor\neg\metavariable{B}$
  by \ref{axiom:s2}($\neg\metavariable{A}$, $\neg\metavariable{B}$)
\item\label{dc21:1:2} $\vdash\neg\metavariable{A}\implies\neg(\metavariable{A}\land\metavariable{B})$
  by \ref{dc:6}(\ref{dc21:1:1}, definition of conjunction)
\item\label{dc21:1:3} $\vdash(\neg\metavariable{A}\implies\neg(\metavariable{A}\land\metavariable{B}))\implies(\metavariable{A}\land\metavariable{B}\implies\metavariable{A})$
  by \ref{dc:17}($\metavariable{A}\land\metavariable{B}$, $\metavariable{A}$)
\item $\vdash\metavariable{A}\land\metavariable{B}\implies\metavariable{A}$
  by MP(\ref{dc21:1:3}, \ref{dc21:1:2})
\end{pf}
\item 
\begin{pf}
\item\label{dc21:2:1} $\vdash\neg\metavariable{B}\implies\neg\metavariable{A}\lor\neg\metavariable{B}$
  by \ref{dc:7}($\neg\metavariable{A}$, $\neg\metavariable{B}$)
\item\label{dc21:2:2} $\vdash\neg\metavariable{B}\implies\neg(\metavariable{A}\land\metavariable{B})$
  by \ref{dc:6}(\ref{dc21:2:1}, definition of conjunction)
\item\label{dc21:2:3} $\vdash(\neg\metavariable{B}\implies\neg(\metavariable{A}\land\metavariable{B}))\implies(\metavariable{A}\land\metavariable{B}\implies\metavariable{B})$
  by \ref{dc:17}($\metavariable{A}\land\metavariable{B}$, $\metavariable{B}$)
\item\label{dc21:2:4} $\vdash\metavariable{A}\land\metavariable{B}\implies\metavariable{B}$
  by MP(\ref{dc21:2:3}, \ref{dc21:2:2})
\end{pf}
\end{enumerate}

\begin{lemma}\label{lm:prop:and-duplication}
$\vdash\metavariable{A}\implies\metavariable{A}\land\metavariable{A}$
\end{lemma}
...
\begin{enumerate}[start=0]
\item \begin{pf}
\item\label{dc22:1:1} $\vdash\metavariable{A}\implies\metavariable{A}$
  by \ref{dc:8}($\metavariable{A}$)
\item\label{dc22:1:2} $\vdash(\metavariable{A}\implies\metavariable{A})\implies\bigl((\metavariable{A}\implies\metavariable{A})\land(\metavariable{A}\implies\metavariable{A})\bigr)$
  by Lm\ref{lm:prop:and-duplication}($\metavariable{A}\implies\metavariable{A}$)
\item\label{dc22:1:2} $\vdash\metavariable{A}\iff\metavariable{A}$ by MP(.2,.1)
%\item\label{dc22:1:}
\end{pf}

...
\>[B]{}\mathbf{import}\;\Conid{\Conid{Data}.Set}{}\<[E]%
\\
...
\>[25]{}\mathrel{=}{}\<[25E]%
\>[28]{}\Varid{subst}\;\Varid{x}\;\Varid{t}\;\Varid{r}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{simp}\;(\Conid{REq}\;\Varid{a}\;\Varid{b}){}\<[19]%
\>[19]{}\mathrel{=}{}\<[19E]%
\>[22]{}\Conid{REq}\;(\Varid{simp}\;\Varid{a})\;(\Varid{simp}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[24]{}\mathrel{=}{}\<[24E]%
\>[27]{}\Varid{subst}\;\Varid{x}\;\Varid{t}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[B]{}\Varid{exists}{}\<[15]%
\>[15]{}\mathbin{::}{}\<[15E]%
\>[19]{}\Conid{Letter}\to \Conid{Relation}\to \Conid{Relation}{}\<[E]%
\\
\>[B]{}\Varid{exists}\;{}\<[9]%
\>[9]{}\Varid{x}\;{}\<[12]%
\>[12]{}\Varid{r}{}\<[15]%
\>[15]{}\mathrel{=}{}\<[15E]%
\>[19]{}\Varid{simp}\mathbin{\$}\Varid{subst}\;(\Varid{tau}\;\Varid{x}\;\Varid{r})\;\Varid{x}\;\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{forall}{}\<[15]%
\>[15]{}\mathbin{::}{}\<[15E]%
\>[19]{}\Conid{Letter}\to \Conid{Relation}\to \Conid{Relation}{}\<[E]%
...
\>[12]{}\Varid{r}{}\<[15]%
\>[15]{}\mathrel{=}{}\<[15E]%
\>[19]{}\Varid{simp}\mathbin{\$}\Conid{RNot}\;(\Varid{exists}\;\Varid{x}\;(\Conid{RNot}\;\Varid{r})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[13]{}\mathbf{in}\;\Varid{tau}\;\mathrm{0}\;\Varid{y}\;(\Varid{forall}\;\Varid{x}\;(\Varid{iff}\;(\Conid{RIn}\;(\Conid{TVar}\;\Varid{x})\;(\Conid{TVar}\;\Varid{y}))\;\Varid{r})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[19]{}\Varid{y}{}\<[25]%
\>[25]{}\mathrel{=}{}\<[25E]%
\>[28]{}\Varid{pair}\;(\Varid{ssingleton}\;\Varid{x})\;(\Varid{pair}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\[\blanklineskip]%
...
\>[37]{}(\Varid{and}\;{}\<[43]%
\>[43]{}(\Conid{REq}\;{}\<[49]%
\>[49]{}(\Conid{TVar}\;\text{\ttfamily \char34 z\char34})\;(\Varid{orderedPair}\;(\Conid{TVar}\;\text{\ttfamily \char34 x'\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 y'\char34})))\;{}\<[E]%
\\
\>[43]{}(\Varid{and}\;{}\<[49]%
...
\\
\>[B]{}\Varid{subset}\;\Varid{u}\;\Varid{v}\mathrel{=}\Varid{forall}\;\text{\ttfamily \char34 s\char34}\;(\Varid{implies}\;(\Conid{RIn}\;(\Conid{TVar}\;\text{\ttfamily \char34 s\char34})\;\Varid{u})\;(\Conid{RIn}\;(\Conid{TVar}\;\text{\ttfamily \char34 s\char34})\;\Varid{v})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{emptySet}\mathrel{=}\Varid{tau}\;\mathrm{0}\;\text{\ttfamily \char34 X\char34}\;(\Varid{forall}\;\text{\ttfamily \char34 y\char34}\;(\Conid{RNot}\;(\Conid{RIn}\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 X\char34})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{termC}\;\Varid{x}\;\Varid{upperU}\mathrel{=}\Varid{forall}\;\text{\ttfamily \char34 x\char34}\;(\Varid{implies}\;{}\<[39]%
\>[39]{}(\Conid{RIn}\;(\Conid{TVar}\;\text{\ttfamily \char34 x\char34})\;\Varid{x})\;{}\<[E]%
\\
\>[39]{}(\Varid{exists}\;\text{\ttfamily \char34 y\char34}\;(\Conid{RIn}\;{}\<[57]%
\>[57]{}(\Varid{orderedPair}\;(\Conid{TVar}\;\text{\ttfamily \char34 x\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34}))\;{}\<[E]%
\\
\>[57]{}(\Conid{TVar}\;\Varid{upperU})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{termD}\mathbin{::}\Conid{Letter}\to \Conid{Relation}{}\<[E]%
\\
\>[B]{}\Varid{termD}\;\Varid{upperU}\mathrel{=}\Varid{forall}\;\text{\ttfamily \char34 x\char34}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}(\Varid{forall}\;\text{\ttfamily \char34 y\char34}\;(\Varid{forall}\;\text{\ttfamily \char34 z\char34}\;{}\<[E]%
\\
\>[3]{}\hsindent{14}{}\<[17]%
\>[17]{}(\Varid{implies}\;{}\<[27]%
\>[27]{}(\Varid{and}\;{}\<[33]%
\>[33]{}(\Conid{RIn}\;(\Varid{orderedPair}\;(\Conid{TVar}\;\text{\ttfamily \char34 x\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34}))\;(\Conid{TVar}\;\Varid{upperU}))\;{}\<[E]%
\\
\>[33]{}(\Conid{RIn}\;(\Varid{orderedPair}\;(\Conid{TVar}\;\text{\ttfamily \char34 x\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 z\char34}))\;(\Conid{TVar}\;\Varid{upperU})))\;{}\<[E]%
\\
\>[27]{}(\Conid{REq}\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 z\char34}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{termE}\mathbin{::}\Conid{Letter}\to \Conid{Letter}\to \Conid{Relation}{}\<[E]%
\\
\>[B]{}\Varid{termE}\;\Varid{upperU}\;\Varid{z}\mathrel{=}\Varid{forall}\;\text{\ttfamily \char34 y\char34}\;(\Varid{implies}\;{}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}(\Conid{RIn}\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34})\;(\Conid{TVar}\;\Varid{z}))\;{}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}(\Varid{exists}\;\text{\ttfamily \char34 x\char34}\;(\Conid{RIn}\;{}\<[49]%
\>[49]{}(\Varid{orderedPair}\;(\Conid{TVar}\;\text{\ttfamily \char34 x\char34})\;(\Conid{TVar}\;\text{\ttfamily \char34 y\char34}))\;{}\<[E]%
\\
\>[49]{}(\Conid{TVar}\;\Varid{upperU})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{card}\mathbin{::}\Conid{Term}\to \Conid{Term}{}\<[E]%
\\
\>[B]{}\Varid{card}\;\Varid{x}\mathrel{=}\Varid{tau}\;\mathrm{0}\;\text{\ttfamily \char34 Z\char34}\;(\Varid{exists}\;\text{\ttfamily \char34 u\char34}\;(\Varid{exists}\;\text{\ttfamily \char34 U\char34}\;(\Varid{and}\;{}\<[50]%
\>[50]{}(\Varid{termA}\;\Varid{x}\;\text{\ttfamily \char34 u\char34}\;\text{\ttfamily \char34 U\char34}\;\text{\ttfamily \char34 Z\char34})\;{}\<[E]%
\\
\>[50]{}(\Varid{and}\;{}\<[56]%
\>[56]{}(\Varid{termB}\;\Varid{x}\;\text{\ttfamily \char34 U\char34}\;\text{\ttfamily \char34 Z\char34})\;{}\<[E]%
\\
\>[56]{}(\Varid{and}\;{}\<[62]%
\>[62]{}(\Varid{termC}\;\Varid{x}\;\text{\ttfamily \char34 U\char34})\;{}\<[E]%
\\
\>[62]{}(\Varid{and}\;{}\<[68]%
\>[68]{}(\Varid{termD}\;\text{\ttfamily \char34 U\char34})\;{}\<[E]%
\\
\>[68]{}(\Varid{termE}\;\text{\ttfamily \char34 U\char34}\;\text{\ttfamily \char34 Z\char34}))))))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
